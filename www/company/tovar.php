		...
		<main>
			...
			<div id="left_sitebar">
				...
				<ul>
					...
					<li class="active"><a href="#">Промышленные ворота</a>
						<ul>
							<li><a href="#">Промышленные секционные ворота</a></li>
							<li><a href="#">Откатные ворота</a></li>
							<li class="active"><a href="#">Скоростные ворота</a></li>
			...
			<div id="right_box">
				...
				<div class="product_card_description">
					<h2>Гибкие быстроскручивающиеся ворота, движущиеся в вертикальном направлении V 3009</h2>
					...
					<a class="more_product" href="#">послать запрос менеджеру</a>
				</div>
				...
				<div id="center">
					...
					<ul id="tabsText">
						<li>
							<p><b>Эти тяжелые ворота отличаются высоким стандартом безопасности</b><br />Прочные ворота V4014 с полотном из ткани толщиной 1,5 мм и прозрачным смотровым окном имеют очень прочную конструкцию. Поэтому их используют предпочтительно при тяжелых условиях эксплуатации в промышленности, торговли и мелком производстве. Они пригодны также для использования в условиях ветровой нагрузки величиной до 25 км/час. Щеточные уплотнения исключают сквозняки и обеспечивают легкий ход ворот.</p>
							<p><b>Полное оснащение средствами безопасности</b><br />Стандартное оснащение включает в себя предохранитель замыкающего контура световой барьер и энергетическую цепь. По желанию ворота оснащаются защитой от наезда. Преобразователь частоты и компактный редуктор защищают механику и снижают до минимума затраты на техническое обслуживание. Использование в низкотемпературных складах. Эти быстроскручивающиеся ворота в комбинации с откатной дверью, предназначенной для низкотемпературных помещений, рекомендуются в качестве дополнительного разделительного барьера разно-температурных зон для установки перед камерами глубокого замораживания. Обогреваемые направляющие и электрическое соединение с откатной дверью гарантируют надежную работу ворот.
							</p>
						</li>
						<li>
							<b>Скорость (м/с):</b><br>
							Открывание — 0,9<br>
							Закрывание — 0,9<br><br>
							<b>Размер ворот (мм):</b><br>
							Ширина (LB) — 3000<br>
							Высота (LH) — 3000<br><br>
							<b>Завеса, толщина (мм):</b><br>
							Ткань/смотровое поле — 0,8/1,5<br><br>
							<b>Необходимое пространство (мм):</b><br>
							На стороне привода LB + — 310<br>
							На стороне опоры LB + — 150<br>
							Перемычка LH + — 300<br>
							Шкаф управления (ВхНхТ) — 160x240x90
						</li>
					</ul>
				</div>
