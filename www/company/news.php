		...
		<header>
			...
			<div class="top_menu">
				<ul>
					...
					<li class="active"><a href="/company/news.php">Новости</a></li>
		...
		<main>
			...
			<div id="right_box">
				...
				<div class="news_anons">
					...
					<a class="title_news-anons" href="/company/news-one.php">Гибкие быстроскручивающиеся ворота, движущиеся в вертикальном направлении V 3009</a>
					<p class="text_news-anons">быстроскручивающиеся ворота Стандартные вертикальные ворота для внутреннего использования в дневное время в дневное время стандартные вертикальные ворота для внутреннего использования вертикальные ворота для внутреннего использования в дневное время в дневное время стандартные вертикальные ворота для внутреннего использования</p>
				</div>
